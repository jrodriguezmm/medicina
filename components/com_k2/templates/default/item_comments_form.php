...
<p>Este es un espacio designado a compartir comentarios, opciones de mejora y felicitaciones para el equipo que realiza la presentación. <br>
	<em>Este es un espacio abierto y todos los usuarios podrán ver los comentarios</em></p>
<?php endif; ?>
