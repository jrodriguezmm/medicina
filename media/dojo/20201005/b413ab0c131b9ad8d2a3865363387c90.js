    ...
    dojo.connect(el, "change", function(){
      this.c[0].color.active.val("hex", this.value);
        ...
        new FontConfigurator({
          ...
          defaultTab: "Text",
          origsettings: {"Text":{"lineheight":"normal","type":"Latin","subset":"Latin","family":"Montserrat","size":"20||px","color":"ede7d9","afont":"Helvetica||1","underline":"0","textdecor":"300","align":"center"},"Link":{"color":"1685d7","underline":"0"},"Hover":{"color":"1186bb","underline":"0"}},
