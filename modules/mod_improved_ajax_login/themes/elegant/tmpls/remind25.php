...
<?php endif ?>
  <div class="gi-elem">
    <button class="loginBtn ial-remind" id="remindBtn" style="width: 100%; margin-bottom: 10px"><span><i class="ial-load"></i><span><?php echo JText::_('JSUBMIT')?></span></span></button>
  </div>
