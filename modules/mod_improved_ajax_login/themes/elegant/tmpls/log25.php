...
<?php if (!$loginpopup): ?><div class="loginInside"><?php endif ?>
...
<form action="<?php echo JRoute::_('index.php') ?>" method="post" name="ialLogin" class="ial-login <?php if (!$loginpopup) echo 'fullWidth' ?> ialLoginBaseForm">
  ...
  <?php endif; ?>
  <div class="gi-elem gi-wide">
    <button class="loginBtn ial-submit" id="submitBtn"><span><i class="ial-load"></i><span><?php echo JText::_('JLOGIN')?></span></span></button>
  </div>
  <div class="gi-elem gi-wide">
